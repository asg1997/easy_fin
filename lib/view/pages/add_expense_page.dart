...
class _AddExpensePageState extends ConsumerState<AddExpensePage> {
  ...
  final _categoriesPanelKey = GlobalKey<_ExpenseCategoriesPanelState>();
  ...
  ExpenseDocumentAccount _toDocumentAccount(_DocumentAccountOption option) {
    return switch (option) {
      ...
      _BankAccountOption(:final account) => ExpenseDocumentBankAccount(
    ...
    return CallbackShortcuts(
      bindings: {
        appPrimaryShortcut(LogicalKeyboardKey.keyN): () {
          _categoriesPanelKey.currentState?.focusSearchAndClear();
        },
      },
      child: Focus(
        autofocus: true,
